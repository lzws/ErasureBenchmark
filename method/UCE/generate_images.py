...
import argparse
import os
def generate_images(evaluation_task, model_name, prompts_path, save_path, device='cuda:0', guidance_scale = 7.5, image_size=512, ddim_steps=40, num_samples=1, from_case=0):
    ...
    print(f'UCE 任务：{evaluation_task},加载模型：{model_name}， 保存路径：{folder_path}')
