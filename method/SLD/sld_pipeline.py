...
from .__init__ import SLDPipelineOutput
...
class SLDPipeline(DiffusionPipeline):
    ...
    def __init__(
        ...
        safety_checker: StableDiffusionSafetyChecker,
        feature_extractor: CLIPFeatureExtractor,
        safety_concept: Optional[str] = None
    ):
        super().__init__()
        # 
        print('safety_concept:',  safety_concept)
        ...
        **kwargs,
        ...
        if do_classifier_free_guidance:
            ...
            if enable_safety_guidance:
                ...
                # 把safety_embeddings也加入到text_embeddings中，用来预测噪声
        ...
        if latents is None:
            if self.device.type == "mps":
                ...
                # print("dtype:", latents_dtype)
                latents = torch.randn(latents_shape, generator=generator, dtype=latents_dtype)
