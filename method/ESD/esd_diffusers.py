...
if __name__ == '__main__':
    ...
    parser.add_argument('--device', help='cuda device to train on', type=str, required=False, default='cuda:1')
    ...
    train(erase_concept=erase_concept, erase_from=erase_from, train_method=train_method, iterations=iterations, negative_guidance=negative_guidance, lr=lr, save_path=save_path, device=args.device)