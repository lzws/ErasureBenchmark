...
from SPM.src.configs import config
from SPM.src.configs.config import RootConfig
from SPM.src.configs.generation_config import GenerationConfig
from SPM.src.engine import train_util
from SPM.src.evaluation import *
from SPM.src.models import model_util
from SPM.src.models.spm import SPMLayer, SPMNetwork
from SPM.src.models.merge_spm import load_state_dict
# from SPM.src.misc.sld_pipeline import SLDPipeline
...
def get_dataloader(task, task_args, prompts_path, img_save_path, generation_cfg, num_processes=1):
    # parse task_args arguments
    task_args = parse_extra_args(task_args)
    task_args["data_path"] = prompts_path
    task_args["save_folder"] = img_save_path
    # task_args["output_path"] = save_path

    # parse generation arguments
    cfg = parse_extra_args(generation_cfg)
