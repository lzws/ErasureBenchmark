...
def main(args):
    ...
    for i, concept in enumerate(args.concepts_list):
        ...
        if (
                ...
                if args.concept_type in ["style", "nudity", "violence"]:
                    if accelerator.is_main_process:
                        ...
                        if (
                            ...
                            print(f"please put caption.txt to {class_images_dir}")
                            # retrieve(
            ...
            # pipe = StableDiffusionXLPipeline.from_pretrained("stabilityai/stable-diffusion-xl-base-1.0", torch_dtype=torch.float16).to(accelerator.device)
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(
                ...
                device_encoder = batch["input_ids"].device
                text_encoder.to(device_encoder)
